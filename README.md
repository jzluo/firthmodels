...
See benchmarks: `FirthLogisticRegression` in [#12](https://github.com/jzluo/firthmodels/issues/12);
`FirthCoxPH` in [#32](https://github.com/jzluo/firthmodels/issues/32).
